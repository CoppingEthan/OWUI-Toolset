...
Writing A Custom Toolkit[​](#writing-a-custom-toolkit "Direct link to Writing A Custom Toolkit")
------------------------------------------------------------------------------------------------

Toolkits are defined in a single Python file, with a top level docstring with metadata and a `Tools` class.

### Example Top-Level Docstring[​](#example-top-level-docstring "Direct link to Example Top-Level Docstring")
...
### Tools Class[​](#tools-class "Direct link to Tools Class")
...
### Type Hints[​](#type-hints "Direct link to Type Hints")
...
### Valves and UserValves - (optional, but HIGHLY encouraged)[​](#valves-and-uservalves---optional-but-highly-encouraged "Direct link to Valves and UserValves - (optional, but HIGHLY encouraged)")

Valves and UserValves are used for specifying customizable settings of the Tool, you can read more on the dedicated [Valves & UserValves page](/features/plugin/valves/).

### Optional Arguments[​](#optional-arguments "Direct link to Optional Arguments")
...
#### Using the OAuth Token in a Tool[​](#using-the-oauth-token-in-a-tool "Direct link to Using the OAuth Token in a Tool")
...
### Event Emitters[​](#event-emitters "Direct link to Event Emitters")
...
#### Function Calling Mode Configuration[​](#function-calling-mode-configuration "Direct link to Function Calling Mode Configuration")
...
#### Complete Event Type Compatibility Matrix[​](#complete-event-type-compatibility-matrix "Direct link to Complete Event Type Compatibility Matrix")
...
#### Why Native Mode Breaks Certain Event Types[​](#why-native-mode-breaks-certain-event-types "Direct link to Why Native Mode Breaks Certain Event Types")
...
#### Best Practices and Recommendations[​](#best-practices-and-recommendations "Direct link to Best Practices and Recommendations")
...
#### Troubleshooting Event Emitter Issues[​](#troubleshooting-event-emitter-issues "Direct link to Troubleshooting Event Emitter Issues")
...
#### Status Events ✅ FULLY COMPATIBLE[​](#status-events--fully-compatible "Direct link to Status Events ✅ FULLY COMPATIBLE")
...
#### Message Events ⚠️ DEFAULT MODE ONLY[​](#message-events-️-default-mode-only "Direct link to Message Events ⚠️ DEFAULT MODE ONLY")
...
#### Citations ✅ FULLY COMPATIBLE[​](#citations--fully-compatible "Direct link to Citations ✅ FULLY COMPATIBLE")
...
#### Additional Compatible Event Types ✅[​](#additional-compatible-event-types- "Direct link to Additional Compatible Event Types ✅")
...
#### Comprehensive Function Calling Mode Guide[​](#comprehensive-function-calling-mode-guide "Direct link to Comprehensive Function Calling Mode Guide")
...
### Rich UI Element Embedding[​](#rich-ui-element-embedding "Direct link to Rich UI Element Embedding")
...
#### External Tool Example[​](#external-tool-example "Direct link to External Tool Example")
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/plugin/tools/development.mdx)

[Previous

⚙️ Tools](/features/plugin/tools/)[Next

⛑️ Events](/features/plugin/events/)

* [Writing A Custom Toolkit](#writing-a-custom-toolkit)
  + [Example Top-Level Docstring](#example-top-level-docstring)
  ...
  + [Rich UI Element Embedding](#rich-ui-element-embedding)
...
- https://docs.openwebui.com/features/auth/
...
- #external-packages
- https://github.com/open-webui/docs/blob/main/docs/features/plugin/tools/development.mdx
- /features/plugin/tools/
- /features/plugin/events/
- #writing-a-custom-toolkit
- #example-top-level-docstring
