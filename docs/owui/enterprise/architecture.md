# https://docs.openwebui.com/enterprise/architecture
...
[ Edit this page](https://github.com/open-webui/docs/blob/main/docs/enterprise/architecture.md)

[PreviousSupport & SLAs](/enterprise/support)[NextPartners & Agencies](/enterprise/partners)
