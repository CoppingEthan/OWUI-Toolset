# https://docs.openwebui.com/enterprise/support
...
[ Edit this page](https://github.com/open-webui/docs/blob/main/docs/enterprise/support.md)

[PreviousSecurity](/enterprise/security)[NextArchitecture & High Availability](/enterprise/architecture)
