...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/getting-started/advanced-topics/logging.md)

[PreviousNetwork Diagrams](/getting-started/advanced-topics/network-diagrams)[NextEnabling HTTPS Encryption](/getting-started/advanced-topics/https-encryption)
