...
_(Replace`YOUR_API_KEY` with your actual API key and `your-open-webui-instance` with your Open WebUI address.)_
...
#### Step 1: Enable API Keys Globally (Admin Required)​
  ...
  6. _(Optional)_ Configure additional API key restrictions:
...
_(Replace`YOUR_API_KEY`, `your-open-webui-instance`, and `llama3.1` with your actual values.)_
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/getting-started/advanced-topics/monitoring/index.md)

[PreviousEnabling HTTPS Encryption](/getting-started/advanced-topics/https-encryption)[NextOpenTelemetry](/getting-started/advanced-topics/monitoring/otel)
