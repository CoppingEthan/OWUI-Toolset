# https://docs.openwebui.com/getting-started/advanced-topics/monitoring/otel
  ...
  * [API Keys & Monitoring](/getting-started/advanced-topics/monitoring/)
  * OpenTelemetry
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/getting-started/advanced-topics/monitoring/otel.md)

[PreviousAPI Keys & Monitoring](/getting-started/advanced-topics/monitoring/)[NextEnvironment Variable Configuration](/getting-started/env-configuration)
