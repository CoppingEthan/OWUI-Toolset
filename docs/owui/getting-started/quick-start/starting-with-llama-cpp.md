...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/getting-started/quick-start/starting-with-llama-cpp.mdx)

[PreviousStarting With OpenAI](/getting-started/quick-start/starting-with-openai)[NextStarting With vLLM](/getting-started/quick-start/starting-with-vllm)
