...
To manage your Ollama instance in Open WebUI, follow these steps:
  ...
  2. Navigate to **Connections > Ollama > Manage** (click the wrench icon). From here, you can download models, configure settings, and manage your connection to Ollama.
...
If you've saved an unreachable URL and can't access Settings to fix it, see the [Model List Loading Issues](/troubleshooting/connection-error#%EF%B8%8F-model-list-loading-issues-slow-ui--unreachable-endpoints) troubleshooting guide.

Here’s what the management screen looks like:

![Ollama Management Screen](/assets/images/manage-ollama-251d27b7f08aaab12160654ea4132fff.png)

![Ollama Management Screen](/assets/images/manage-modal-ollama-f0ae0e218910e1c8f3b709a158d792e1.png)
...
![Ollama Download Prompt](/assets/images/selector-ollama-fab42f51f34d26133d3dcad3b3a13bda.png)
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/getting-started/quick-start/starting-with-ollama.mdx)

[PreviousQuick Start](/getting-started/quick-start/)[NextStarting With OpenAI](/getting-started/quick-start/starting-with-openai)
