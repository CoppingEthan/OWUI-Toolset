...
### 🖥️ User Experience​
  ...
  * 🌈 **Theme Customization** : Personalize your Open WebUI experience with a range of options, including a variety of solid, yet sleek themes, customizable chat background images, and three mode options: Light, Dark, or OLED Dark mode - or let _Her_ choose for you! ;)
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/index.mdx)

[PreviousAPI Endpoints](/getting-started/api-endpoints)[NextFederated Authentication](/category/federated-authentication)
