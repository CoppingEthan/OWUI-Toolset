...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/troubleshooting/audio.mdx)

[PreviousReset Admin Password](/troubleshooting/password-reset)[NextTroubleshooting RAG (Retrieval-Augmented Generation)](/troubleshooting/rag)
