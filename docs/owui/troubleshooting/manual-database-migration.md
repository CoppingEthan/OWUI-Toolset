...
Terminal - Set Environment Variables (Local)
...
Terminal - Fix Missing Secret Key (Local)
...
Never Use "alembic stamp" as a Fix
...
Do Not Use "stamp" to Fix Failed Migrations
...
Terminal - PostgreSQL Integrity Check
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/troubleshooting/manual-database-migration.md)

[PreviousImage Generation](/troubleshooting/image-generation)[Next🏢 Open WebUI for Enterprise](/enterprise/)
