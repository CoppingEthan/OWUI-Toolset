...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/troubleshooting/index.mdx)

[PreviousDirect Connections](/features/experimental/direct-connections)[NextBrowser Compatibility](/troubleshooting/compatibility)
