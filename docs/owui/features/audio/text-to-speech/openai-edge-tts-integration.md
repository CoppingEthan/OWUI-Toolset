# https://docs.openwebui.com/features/audio/text-to-speech/openai-edge-tts-integration
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/audio/text-to-speech/openai-edge-tts-integration.md)

[PreviousOpenAI TTS Integration](/features/audio/text-to-speech/openai-tts-integration)[NextKokoro-FastAPI Using Docker](/features/audio/text-to-speech/Kokoro-FastAPI-integration)
