# https://docs.openwebui.com/features/audio/text-to-speech/Kokoro-FastAPI-integration
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/audio/text-to-speech/Kokoro-FastAPI-integration.md)

[PreviousEdge TTS Using Docker](/features/audio/text-to-speech/openai-edge-tts-integration)[NextKokoro Web - Effortless TTS for Open WebUI](/features/audio/text-to-speech/kokoro-web-integration)
