# https://docs.openwebui.com/features/audio/text-to-speech/kokoro-web-integration
...
[ Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/audio/text-to-speech/kokoro-web-integration.md)

[PreviousKokoro-FastAPI Using Docker](/features/audio/text-to-speech/Kokoro-FastAPI-integration)[NextOpenedai-speech Using Docker](/features/audio/text-to-speech/openedai-speech-integration)
