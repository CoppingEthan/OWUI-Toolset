# https://docs.openwebui.com/features/audio/text-to-speech/openai-tts-integration
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/audio/text-to-speech/openai-tts-integration.md)

[PreviousText-to-Speech](/category/text-to-speech)[NextEdge TTS Using Docker](/features/audio/text-to-speech/openai-edge-tts-integration)
