# https://docs.openwebui.com/features/audio/text-to-speech/chatterbox-tts-api-integration
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/audio/text-to-speech/chatterbox-tts-api-integration.md)

[PreviousOpenedai-speech Using Docker](/features/audio/text-to-speech/openedai-speech-integration)[NextWeb Search](/category/web-search)
