# https://docs.openwebui.com/features/audio/speech-to-text/openai-stt-integration
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/audio/speech-to-text/openai-stt-integration.md)

[PreviousSpeech To Text](/category/speech-to-text)[NextConfiguration](/features/audio/speech-to-text/stt-config)
