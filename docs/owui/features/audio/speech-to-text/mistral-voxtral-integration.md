# https://docs.openwebui.com/features/audio/speech-to-text/mistral-voxtral-integration
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/audio/speech-to-text/mistral-voxtral-integration.md)

[PreviousEnvironment Variables](/features/audio/speech-to-text/env-variables)[NextText-to-Speech](/category/text-to-speech)
