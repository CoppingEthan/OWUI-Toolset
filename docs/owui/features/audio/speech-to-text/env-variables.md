# https://docs.openwebui.com/features/audio/speech-to-text/env-variables
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/audio/speech-to-text/env-variables.md)

[PreviousConfiguration](/features/audio/speech-to-text/stt-config)[NextMistral Voxtral STT](/features/audio/speech-to-text/mistral-voxtral-integration)
