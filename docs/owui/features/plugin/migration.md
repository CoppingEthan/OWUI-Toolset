...
💬 **Questions or Feedback?** If you run into any issues or have suggestions, feel free to open a [GitHub issue](https://github.com/open-webui/open-webui) or ask in the community forums!

Happy coding! ✨

[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/plugin/migration/index.mdx)

[PreviousReserved Arguments](/features/plugin/development/reserved-args)[NextCreate & Edit Images](/category/create--edit-images)
