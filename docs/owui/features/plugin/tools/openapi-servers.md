...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/plugin/tools/openapi-servers/index.mdx)

[PreviousDevelopment](/features/plugin/tools/development)[NextOpen WebUI Integration](/features/plugin/tools/openapi-servers/open-webui)
