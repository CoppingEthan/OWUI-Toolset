# https://docs.openwebui.com/features/plugin/tools/openapi-servers/faq

  * [](/)
  * [⭐ Features](/features/)
  * [Tools & Functions (Plugins)](/features/plugin/)
  * [Tools](/features/plugin/tools/)
  * [OpenAPI Tool Servers](/features/plugin/tools/openapi-servers/)
  * FAQ
...
🙋 Have more questions? Visit the GitHub discussions for help and feedback from the community: 👉 [Community Discussions](https://github.com/open-webui/openapi-servers/discussions)

[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/plugin/tools/openapi-servers/faq.mdx)

[PreviousMCP Support](/features/plugin/tools/openapi-servers/mcp)[NextDevelopment](/category/development)
