...
### 1\. [**Pipe Function** – Create Custom "Agents/Models"](/features/plugin/functions/pipe)​
...
**Use case example:** Imagine you want to query Google Search directly from Open WebUI. You can create a Pipe Function that:
...
### 2\. [**Filter Function** – Modify Inputs and Outputs](/features/plugin/functions/filter)​

A **Filter Function** is like a tool for tweaking data before it gets sent to the AI **or** after it comes back.

**What does it do?** Filters act as "hooks" in the workflow and have two main parts:
...
**Use case example:** Suppose you’re working on a project that needs precise formatting. You can use a Filter to ensure:
...
### 3\. [**Action Function** – Add Custom Buttons](/features/plugin/functions/action)​
...
**Use case example:** Let’s say you often need to summarize long messages or generate specific outputs like translations. You can create an Action Function to:
...
[PreviousTools & Functions (Plugins)](/features/plugin/)[NextAction Function](/features/plugin/functions/action)
