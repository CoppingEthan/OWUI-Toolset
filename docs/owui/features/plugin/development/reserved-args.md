...
An instance of `fastapi.Request`. You can read more in the [migration page](/features/plugin/migration/) or in [fastapi's documentation](https://fastapi.tiangolo.com/reference/request/).
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/plugin/development/reserved-args.mdx)

[PreviousValves](/features/plugin/development/valves)[NextMigrating Tools & Functions: 0.4 to 0.5](/features/plugin/migration/)
