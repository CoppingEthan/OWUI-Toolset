...
A scaffold of Action code can be found [in the community section](https://openwebui.com/f/hub/custom_action/). For more Action Function examples built by the community, visit <https://openwebui.com/search>.
...
[PreviousFunctions](/features/plugin/functions/)[NextFilter Function](/features/plugin/functions/filter)
