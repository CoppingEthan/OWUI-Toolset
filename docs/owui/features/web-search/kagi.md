# https://docs.openwebui.com/features/web-search/kagi
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/web-search/kagi.md)

[PreviousJina](/features/web-search/jina)[NextMojeek](/features/web-search/mojeek)
