# https://docs.openwebui.com/features/web-search/jina
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/web-search/jina.md)

[PreviousGoogle PSE](/features/web-search/google-pse)[NextKagi](/features/web-search/kagi)
