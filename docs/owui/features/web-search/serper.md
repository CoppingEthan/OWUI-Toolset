# https://docs.openwebui.com/features/web-search/serper
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/web-search/serper.md)

[PreviousSerpApi](/features/web-search/serpapi)[NextSerply](/features/web-search/serply)
