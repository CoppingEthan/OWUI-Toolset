...
**Reasoning**|  Model processes data _after_ system injection.| Model can search, read, check, and search again.  
...
## Next Steps​
  ...
  * **Save your findings** : Learn how to [save web search results directly to your Knowledge Base](/features/web-search/save-to-knowledge).
  * **Troubleshoot** : If you encounter issues, check the [Web Search Troubleshooting Guide](/troubleshooting/web-search).



[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/web-search/agentic-search.mdx)

[PreviousWeb Search](/category/web-search)[NextBing](/features/web-search/bing)
