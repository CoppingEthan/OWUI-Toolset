# https://docs.openwebui.com/features/web-search/exa
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/web-search/exa.md)

[PreviousDDGS](/features/web-search/ddgs)[NextGoogle PSE](/features/web-search/google-pse)
