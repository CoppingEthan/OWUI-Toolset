# https://docs.openwebui.com/features/web-search/external
...
![Open WebUI Admin panel showing External Search config](/assets/images/tutorial_external_search-9833e21c5f425849b8951c86307df9ed.png)
...
Open WebUI will interact with your `External Search URL` as follows:
  ...
  * **Expected Response Body (JSON):** Your API endpoint _must_ return a JSON array of search result objects. Each object should have the following structure:
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/web-search/external.md)

[PreviousYacy](/features/web-search/yacy)[NextPerplexity](/features/web-search/perplexity)
