# https://docs.openwebui.com/features/web-search/brave
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/web-search/brave.md)

[PreviousBing](/features/web-search/bing)[NextDDGS](/features/web-search/ddgs)
