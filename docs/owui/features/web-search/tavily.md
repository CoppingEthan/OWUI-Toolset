# https://docs.openwebui.com/features/web-search/tavily
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/web-search/tavily.md)

[PreviousSerpstack](/features/web-search/serpstack)[NextYacy](/features/web-search/yacy)
