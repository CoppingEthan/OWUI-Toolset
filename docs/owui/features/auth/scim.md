# https://docs.openwebui.com/features/auth/scim
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/auth/scim.mdx)

[PreviousLDAP Authentication](/features/auth/ldap)[NextChat Features](/features/chat-features/)
