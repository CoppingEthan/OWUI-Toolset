# https://docs.openwebui.com/features/auth/ldap
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/auth/ldap.mdx)

[PreviousKeycloak](/features/auth/sso/keycloak)[NextSCIM 2.0](/features/auth/scim)
