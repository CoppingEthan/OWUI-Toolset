# https://docs.openwebui.com/features/chat-features/multi-model-chats
...
## How to Use​
  ...
  1. **Select Models** : In the chat header (Model Selector), click the **\+ (Plus)** button to add more models to your current session.
     * _Example Setup_ : Select **GPT-5.1 Thinking** (for reasoning), **Gemini 3** (for creative writing), and **Claude Sonnet 4.5** (for overall performance).
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/chat-features/multi-model-chats.mdx)

[PreviousMermaidJS Rendering](/features/chat-features/code-execution/mermaid)[NextChat Sharing](/features/chat-features/chatshare)
