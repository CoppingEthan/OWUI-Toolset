# https://docs.openwebui.com/features/chat-features/code-execution/mermaid

  * [](/)
  * [⭐ Features](/features/)
  * [Chat Features](/features/chat-features/)
  * [Code Execution](/features/chat-features/code-execution/)
  * MermaidJS Rendering
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/chat-features/code-execution/mermaid.md)

[PreviousPython Code Execution](/features/chat-features/code-execution/python)[NextMulti-Model Chats](/features/chat-features/multi-model-chats)
