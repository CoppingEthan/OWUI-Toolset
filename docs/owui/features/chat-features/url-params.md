# https://docs.openwebui.com/features/chat-features/url-params
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/chat-features/url-params.md)

[PreviousChat Parameters](/features/chat-features/chat-params)[NextHistory & Search](/features/chat-features/history-search)
