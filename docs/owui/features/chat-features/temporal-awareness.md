# https://docs.openwebui.com/features/chat-features/temporal-awareness
...
If you ask: _"Find the notes I wrote last Tuesday,"_ a model without tools might guess the date incorrectly. A tool-equipped model will:
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/chat-features/temporal-awareness.mdx)

[PreviousReasoning & Thinking Models](/features/chat-features/reasoning-models)[NextRetrieval Augmented Generation (RAG)](/features/rag/)
