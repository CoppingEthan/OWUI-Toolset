# https://docs.openwebui.com/features/chat-features/history-search
...
This allows the model to leverage its own previous work. You can ask: _"What was the feedback I got on my last email draft?"_ or _"Find the Python script I wrote about image processing two weeks ago."_
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/chat-features/history-search.mdx)

[PreviousURL Parameters](/features/chat-features/url-params)[NextReasoning & Thinking Models](/features/chat-features/reasoning-models)
