...
![Arena Model Example](/assets/images/arena-b4f026d00272fe8fc05a43e2a7881b49.png)

Need more depth? You can even replicate a [**Chatbot Arena**](https://lmarena.ai/)-style setup!

![Chatbot Arena Example](/assets/images/arena-many-ab44092214ccd04935d917d6d78d9686.png)
...
![Normal Model Rating Interface](/assets/images/normal-229197e953906b743380f9bc852b89fa.png)

And here's an example of setting up a multi-model comparison, similar to an arena:

![Multi-Model Comparison](/assets/images/normal-many-a6a97df9359f2789f5578b79edc109f1.png)
...
![Leaderboard Example](/assets/images/leaderboard-06496432d69174aa1e320a06c2015b95.png)
...
![Reranking Leaderboard by Topic](/assets/images/leaderboard-reranked-d963aa3cc2a8b9561a62e017accfb493.png)

* * *

### Side Note: Chat Snapshots for Model Fine-Tuning​

Whenever you rate a model’s response, Open WebUI _captures a snapshot of that chat_. These snapshots can eventually be used to **fine-tune your own models** —so your evaluations feed into the continuous improvement of the AI.

_(Stay tuned for more updates on this feature, it's actively being developed!)_
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/evaluation/index.mdx)

[PreviousChannels](/features/channels/)[NextModel Context Protocol (MCP)](/features/mcp)
