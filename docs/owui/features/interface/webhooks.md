...
**Endpoint:** `POST {webhook_url}` **Headers:** `Content-Type: application/json` **Body:**
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/interface/webhooks.md)

[PreviousCustomizable Banners](/features/interface/banners)[NextChannels](/features/channels/)
