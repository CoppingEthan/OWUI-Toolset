...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/plugin/index.mdx)

[PreviousRoles](/features/rbac/roles)[NextFunctions](/features/plugin/functions/)
