...
Quality Models for Knowledge Exploration
...
Important: Async File Processing
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/workspace/knowledge.md)

[PreviousPrompts](/features/workspace/prompts)[NextRole-Based Access Control (RBAC)](/features/rbac/)
