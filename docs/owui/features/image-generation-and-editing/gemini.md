# https://docs.openwebui.com/features/image-generation-and-editing/gemini
...
![Screenshot of the Open WebUI Images settings page with Gemini selected and the API key, model, and image size fields highlighted.](/assets/images/gemini-settings-542b7a927bdbf00fe358f2b0882a0be6.png)
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/image-generation-and-editing/gemini.mdx)

[PreviousOpenAI](/features/image-generation-and-editing/openai)[NextImage Router](/features/image-generation-and-editing/image-router)
