# https://docs.openwebui.com/features/image-generation-and-editing/comfyui
...
![Screenshot of the ComfyUI server startup command with the --listen flag highlighted.](/assets/images/comfyui-listen-flag-e0d40fac4633d21dffd548c9a42a802b.png)
...
Since Open WebUI typically runs inside Docker, you must ensure the container can reach the host-based ComfyUI application via `host.docker.internal`.
  ...
  3. **Docker Run Command (Linux Native Docker):** For Linux users not running Docker Desktop, you must explicitly map the host gateway when running the Open WebUI container.
...
![Screenshot of the Open WebUI Images settings page with ComfyUI selected for image generation.](/assets/images/comfyui-generation-settings-ce6724b16cc4e050e39f1322336670c4.png)
...
![Screenshot of the ComfyUI settings with the &quot;Dev Mode&quot; toggle highlighted.](/assets/images/comfyui-dev-mode-3288e286a97e915ef8269bf128a0dc96.png)
...
![Screenshot of the &quot;Save \(API Format\)&quot; button in the ComfyUI interface.](/assets/images/comfyui-save-api-format-e6eb70664f6bd439db8b5ef265411e36.png)

     * Back in Open WebUI, under the **ComfyUI Workflow** section, click **Upload**. Select the JSON workflow file you just downloaded.

![Screenshot of the ComfyUI Workflow section in Open WebUI, showing the upload button.](/assets/images/comfyui-workflow-upload-ce6724b16cc4e050e39f1322336670c4.png)
...
![Screenshot of the ComfyUI Workflow Nodes section in Open WebUI, showing the mapping fields.](/assets/images/comfyui-node-mapping-af54a8aab018cfee43da4a5d5143c046.png)
...
![Screenshot of an image being generated in the chat using ComfyUI.](/assets/images/comfyui-create-image-in-chat-44fe259993050c76738321675431ba32.png)
...
![Screenshot of the Open WebUI Images settings page with ComfyUI selected for image editing.](/assets/images/comfyui-editing-settings-0b0e86ea10f080cf60af54cf2fe08bbd.png)




![Screenshot of an image being edited in the chat using ComfyUI.](/assets/images/comfyui-edit-image-in-chat-f5104ea01a74b41969ee472f692e627d.png)
...
![Screenshot of the ComfyUI interface with a node selected, highlighting the node ID in the properties panel.](/assets/images/comfyui-node-mapping-af54a8aab018cfee43da4a5d5143c046.png)
...
![Screenshot of the ComfyUI interface with the UNETLoader node selected, highlighting the node ID and the &#39;seed&#39; and &#39;steps&#39; input fields.](/assets/images/comfyui-unet-name-node-ce6724b16cc4e050e39f1322336670c4.png)
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/image-generation-and-editing/comfyui.md)

[PreviousAUTOMATIC1111](/features/image-generation-and-editing/automatic1111)[NextOpenAI](/features/image-generation-and-editing/openai)
