...
![Image Generation Tutorial](/assets/images/tutorial_image_generation_2-574538b92cbec3aec52d37d50e9fa56f.png)
...
### How it works:​
  ...
  * **Natural Language** : You can simply ask the model: _"Generate an image of a cybernetic forest."_
  ...
  * **Editing** : This also supports **Image Editing** (inpainting) via the `edit_image` tool (e.g., _"Make the sky in this image red"_).
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/image-generation-and-editing/usage.md)

[PreviousCreate & Edit Images](/category/create--edit-images)[NextAUTOMATIC1111](/features/image-generation-and-editing/automatic1111)
