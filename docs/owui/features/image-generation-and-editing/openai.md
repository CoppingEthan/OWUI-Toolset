# https://docs.openwebui.com/features/image-generation-and-editing/openai
...
![Screenshot of the Open WebUI Images settings page with Open AI selected and the API key, model, and image size fields highlighted.](/assets/images/openai-settings-b489ff1f23e639eb873d8b4f7259d431.png)
...
![Screenshot of the Open WebUI Images settings page with Open AI selected and the API endpoint URL, API version, and API key fields highlighted for Azure OpenAI configuration.](/assets/images/azure-openai-settings-b489ff1f23e639eb873d8b4f7259d431.png)

Azure GPT-Image-1.5 Configuration
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/image-generation-and-editing/openai.md)

[PreviousComfyUI](/features/image-generation-and-editing/comfyui)[NextGemini](/features/image-generation-and-editing/gemini)
