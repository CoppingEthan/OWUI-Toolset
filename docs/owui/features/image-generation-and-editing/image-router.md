# https://docs.openwebui.com/features/image-generation-and-editing/image-router
...
![Screenshot of the Open WebUI Images settings page with Open AI selected and the API endpoint URL, API key, and model fields highlighted for Image Router configuration.](/assets/images/image-router-settings-b489ff1f23e639eb873d8b4f7259d431.png)

[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/image-generation-and-editing/image-router.md)

[PreviousGemini](/features/image-generation-and-editing/gemini)[NextSpeech-to-Text & Text-to-Speech](/category/speech-to-text--text-to-speech)
