# https://docs.openwebui.com/features/rbac/roles
...
Open WebUI defines three primary **System Roles** that determine the fundamental access level of a user account. These roles are distinct from [Groups](/features/rbac/groups) and [Permissions](/features/rbac/permissions).
...
This is the default functional role for team members.
  ...
  * **Additive Rights** : As explained in the [Permissions](/features/rbac/permissions) section, their effective rights are the sum of all their grants.
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/rbac/roles.md)

[PreviousPermissions](/features/rbac/permissions)[NextTools & Functions (Plugins)](/features/plugin/)
