# https://docs.openwebui.com/features/rbac/groups
...
Open WebUI permissions are **additive** (Union-based).
  ...
  * If _Group A_ allows "Image Generation" and _Group B_ does not, a user in both groups **WILL** have access to Image Generation.
...
A group definition typically includes:
  ...
  * **Permissions** : A detailed JSON object overriding default user permissions (see [Permissions](/features/rbac/permissions)).
...
When editing a group, you can toggle specific permissions.
  ...
  * **Default State** : By default, a group grants _no_ extra permissions; members rely on the global defaults.
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/rbac/groups.md)

[PreviousRole-Based Access Control (RBAC)](/features/rbac/)[NextPermissions](/features/rbac/permissions)
