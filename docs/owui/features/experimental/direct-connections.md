# https://docs.openwebui.com/features/experimental/direct-connections
...
## Prerequisites​
  ...
  2. **CORS Configuration** : Since the browser is making the request, the API provider must have **Cross-Origin Resource Sharing (CORS)** configured to allow requests from your Open WebUI domain.
     * _Note: Many strict providers (like official OpenAI) might block direct browser requests due to CORS policies. This feature is often best used with flexible providers or internal API gateways._
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/features/experimental/direct-connections.mdx)

[PreviousTutorials](/features/pipelines/tutorials)[Next🛠️ Troubleshooting](/troubleshooting/)
