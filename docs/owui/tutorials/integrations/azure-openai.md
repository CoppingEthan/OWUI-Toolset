# https://docs.openwebui.com/tutorials/integrations/azure-openai/
...
[**→ Learn how to set up Azure CLI Authentication**](/tutorials/integrations/azure-openai/azure-cli-auth)
...
[**→ Learn how to set up Workload Identity Authentication**](/tutorials/integrations/azure-openai/workload-identity-auth)
...
Choose the authentication method that best fits your deployment environment:
  ...
  * **For local development or Docker deployments** : Start with [Azure CLI Authentication](/tutorials/integrations/azure-openai/azure-cli-auth)
  * **For production AKS deployments** : Use [Workload Identity Authentication](/tutorials/integrations/azure-openai/workload-identity-auth)
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/tutorials/integrations/azure-openai/index.mdx)

[PreviousIntegrations](/category/integrations)[NextAzure CLI Authentication](/tutorials/integrations/azure-openai/azure-cli-auth)
