...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/tutorials/integrations/onedrive-sharepoint.mdx)

[PreviousIntegrate with MiniMax M2.1](/tutorials/integrations/minimax)[NextOkta OIDC SSO Integration](/tutorials/integrations/okta-oidc-sso)
