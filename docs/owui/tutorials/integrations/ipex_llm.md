...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/tutorials/integrations/ipex_llm.md)

[PreviousBackend-Controlled, UI-Compatible API Flow](/tutorials/integrations/backend-controlled-ui-compatible-flow)[NextContinue.dev VS Code Extension with Open WebUI](/tutorials/integrations/continue-dev)
