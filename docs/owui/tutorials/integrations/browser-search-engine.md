# https://docs.openwebui.com/tutorials/integrations/browser-search-engine
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/tutorials/integrations/browser-search-engine.md)

[PreviousSetting up with Custom CA Store](/tutorials/integrations/custom-ca)[NextMonitor your LLM requests with Helicone](/tutorials/integrations/helicone)
