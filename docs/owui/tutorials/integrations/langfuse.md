...
![Langfuse Integration](https://langfuse.com/images/docs/openwebui-integration.gif) _Langfuse integration steps_
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/tutorials/integrations/langfuse.md)

[PreviousMonitor your LLM requests with Helicone](/tutorials/integrations/helicone)[NextLibreTranslate Integration](/tutorials/integrations/libre-translate)
