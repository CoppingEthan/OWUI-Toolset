# https://docs.openwebui.com/tutorials/integrations/helicone
...
_— Make sure to generate a[write only API key](https://docs.helicone.ai/helicone-headers/helicone-auth). This ensures you only allow logging data to Helicone without read access to your private data._
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/tutorials/integrations/helicone.md)

[PreviousBrowser Search Engine](/tutorials/integrations/browser-search-engine)[NextMonitoring and Debugging with Langfuse](/tutorials/integrations/langfuse)
