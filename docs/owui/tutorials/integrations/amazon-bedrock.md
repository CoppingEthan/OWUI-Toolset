...
![Amazon Bedrock Base Models](/assets/images/amazon-bedrock-base-models-ffbfa672843480269078215628cbdc39.png)
...
![Bedrock Access Gateway Swagger](/assets/images/amazon-bedrock-proxy-api-34fad958be9cc3c1ae6b272a9e304963.png)
...
![Add New Connection](/assets/images/amazon-bedrock-proxy-connection-08dabeb348c2b900c2b830796b65cd2d.png)

## Step 4: Start using Bedrock Base Models​

You should now see all your Bedrock models available!

![Use Bedrock Models](/assets/images/amazon-bedrock-models-in-oui-49c5061314d3abc3e1b8ec5887beef1f.png)
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/tutorials/integrations/amazon-bedrock.md)

[PreviousRedis Websocket Support](/tutorials/integrations/redis)[NextIntegrate with MiniMax M2.1](/tutorials/integrations/minimax)
