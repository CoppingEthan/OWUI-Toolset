...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/tutorials/integrations/backend-controlled-ui-compatible-flow.md)

[PreviousRun DeepSeek R1 Dynamic 1.58-bit with Llama.cpp](/tutorials/integrations/deepseekr1-dynamic)[NextLocal LLM Setup with IPEX-LLM on Intel GPU](/tutorials/integrations/ipex_llm)
