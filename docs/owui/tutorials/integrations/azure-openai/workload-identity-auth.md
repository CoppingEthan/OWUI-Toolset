# https://docs.openwebui.com/tutorials/integrations/azure-openai/workload-identity-auth
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/tutorials/integrations/azure-openai/workload-identity-auth.mdx)

[PreviousAzure CLI Authentication](/tutorials/integrations/azure-openai/azure-cli-auth)[NextRun DeepSeek R1 Dynamic 1.58-bit with Llama.cpp](/tutorials/integrations/deepseekr1-dynamic)
