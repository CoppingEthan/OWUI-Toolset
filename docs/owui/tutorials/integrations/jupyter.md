# https://docs.openwebui.com/tutorials/integrations/jupyter
...
![Code Execution Configuration](/assets/images/jupyter-code-execution-f4caa315394b7f34947497035c197111.png)
...
![Code Execution Configuration](/assets/images/jupyter-token-1b07b1a7ffb0e2de1c5fd36a95c641d7.png)
...
![Code Execution Configuration](/assets/images/jupyter-empty-900223cd56c402a3adec0f4292d02e07.png)
...
![Code Execution Configuration](/assets/images/jupyter-create-csv-260491be847904a65d0a0d25c4a36e00.png)

We can see the CSVs were created and are now accessible within Jupyter.

![Code Execution Configuration](/assets/images/jupyter-view-csv-d443985b912b9acbc712dd7b120bc433.png)
...
![Code Execution Configuration](/assets/images/jupyter-create-viz-34a86a7626aed683cace59c7dccec6cb.png)

We can see the visualizations were created and are now accessible within Jupyter.

![Code Execution Configuration](/assets/images/jupyter-view-viz-cd602d8b6fc66a1a46dd4d8a231621ad.png)
...
![Code Execution Configuration](/assets/images/jupyter-create-notebook-c2945001085d8c45870b557e0a1dbe8d.png)

We can see the visualizations were created and are now accessible within Jupyter.

![Code Execution Configuration](/assets/images/jupyter-view-notebook-7c0b39523feac2211727962523b43825.png)
...
![Code Execution Configuration](/assets/images/jupyter-workflow-94ed04edb7dabd3e676adc40c10022d1.png)
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/tutorials/integrations/jupyter.md)

[PreviousNotion MCP Integration](/tutorials/integrations/mcp-notion)[NextFirefox AI Chatbot Sidebar](/tutorials/integrations/firefox-sidebar)
