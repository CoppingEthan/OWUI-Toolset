...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/tutorials/integrations/libre-translate.md)

[PreviousMonitoring and Debugging with Langfuse](/tutorials/integrations/langfuse)[NextRedis Websocket Support](/tutorials/integrations/redis)
