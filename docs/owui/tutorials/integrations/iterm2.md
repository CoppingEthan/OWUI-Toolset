# https://docs.openwebui.com/tutorials/integrations/iterm2
...
If you haven't already installed the iTerm2 AI plugin, you'll need to download it first from [their page](https://iterm2.com/ai-plugin.html). Unzip the file and move the application into your **Applications** folder.
...
![iterm2 menu before setup](/assets/images/iterm2_ai_plugin_before-71b7a9794141c8404c664f8231f41711.png)
...
![iterm2 menu after setup](/assets/images/iterm2_ai_plugin_after-44fe67687a99a2daca4b966bb2b06eff.png)
...
![iterm2 prompt window](/assets/images/iterm2_ai_plugin_prompt_window-ae8e80b6c91861760fab3eacfd0f1d53.png)
...
![iterm2 prompt window](/assets/images/iterm2_ai_plugin_result_window-f321568765d100c31ee511dae7b23fb3.png)

[Edit this page](https://github.com/open-webui/docs/blob/main/docs/tutorials/integrations/iterm2.md)

[PreviousAzure AD Domain Services (LDAPS) Integration](/tutorials/integrations/azure-ad-ds-ldap)[NextMaintenance](/category/maintenance)
