# https://docs.openwebui.com/tutorials/tips/dual-oauth-configuration

  * [](/)
  * [🎓 Tutorials](/category/-tutorials)
  * [Tips & Tricks](/category/tips--tricks)
  * Dual OAuth Configuration
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/tutorials/tips/dual-oauth-configuration.mdx)

[PreviousOne-Click Ollama + Open WebUI Launcher](/tutorials/tips/one-click-ollama-launcher)[NextIntegrations](/category/integrations)
