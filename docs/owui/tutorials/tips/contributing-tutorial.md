# https://docs.openwebui.com/tutorials/tips/contributing-tutorial/
...
[Edit this page](https://github.com/open-webui/docs/blob/main/docs/tutorials/tips/contributing-tutorial.md)

[PreviousTips & Tricks](/category/tips--tricks)[NextOpen WebUI RAG Tutorial](/tutorials/tips/rag-tutorial)
